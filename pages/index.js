  ...
  return (
    <div className="h-screen grid grid-cols-1">
      <div class="place-self-center">
        ...
        <div class="text-center py-10"><button onclick="clickHandler()" class="shadow-2xl hover:bg-zinc-700 text-zinc-700 font-semibold hover:text-white py-2 px-4 border border-zinc-700 hover:border-transparent rounded">Start</button></div>
      </div>
    </div>
  )
}
